            ...
            <article class="deed-article" id="post-<?php echo $post->ID; ?>">
                ...
                <header class="deed-hero">
                    ...
                    <div class="hero-content">
                        <div class="container">
                            <h1 class="deed-title"><?php echo get_the_title($post); ?></h1>
                            <div class="deed-meta">
                ...
                <!-- Main Content Grid -->
                <div class="deed-grid container">
                    <!-- Primary Content Column -->
                    <div class="deed-main-content">
                        
                        <!-- Location Information -->
                        <section class="deed-section location-info">
                        ...
                        <!-- Property Details -->
                        <section class="deed-section property-details">
                            <h2 class="section-title">
                            ...
                            <div class="details-grid">
                                ...
                                $property_details = [
                                    ...
                                    'deed-number' => ['icon' => 'fas fa-map-marker-alt', 'label' => __('Deed Number', 'flex-eland')],
                        ...
                        <!-- Deed Content -->
                        <section class="deed-section deed-content">
                            <h2 class="section-title">
                        ...
                        <!-- Documents Gallery -->
                        <!-- <section class="deed-section documents-gallery">
                            <h2 class="section-title">
                    ...
                    <aside class="deed-sidebar">
                            ...
                            <div class="sidebar-widget image-gallery">
                                ...
                                <div class="gallery-grid">
                                    <?php foreach ($images as $image_id) : 
                                        ...
                                        ?>
                                        <a href="<?php echo esc_url($image_full); ?>" class="gallery-item" data-fancybox="deed-gallery">
                        ...
                        if ($mouza_terms && !is_wp_error($mouza_terms)) :
                            ...
                            if ($related_deeds->have_posts()) : ?>
                                <div class="sidebar-widget related-deeds">
                                    <h3 class="widget-title">
                                            ...
                                            <a href="<?php the_permalink(); ?>" class="related-card">
                                                ...
                                                <div class="related-content">
                                                    ...
                                                    <?php if ($deed_number = get_post_meta(get_the_ID(), 'deed-number', true)) : ?>
                                                        <span class="deed-number"><?php echo esc_html($deed_number); ?></span>
                                                    <?php endif; ?>
                                                </div>
                                            </a>
