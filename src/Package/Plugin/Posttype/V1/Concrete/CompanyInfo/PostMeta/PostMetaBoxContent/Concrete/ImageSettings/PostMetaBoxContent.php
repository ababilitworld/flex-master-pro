<?php
namespace Ababilithub\FlexMasterPro\Package\Plugin\Posttype\V1\Concrete\CompanyInfo\PostMeta\PostMetaBoxContent\Concrete\ImageSettings;
...
class PostMetaBoxContent extends BasePostMetaBoxContent
{
    ...
    public function init(array $data = []) : static
    {
        ...
        $this->tab_item_id = $this->posttype.'-'.'image-settings';
        $this->tab_item_label = esc_html__('Images Settings');
