<?php
namespace Ababilithub\FlexMasterPro\Package\Plugin\OptionBox\V1\Manager;
...
use Ababilithub\{
    ...
    FlexMasterPro\Package\Plugin\OptionBox\V1\Concrete\VerticalTabBox\OptionBox as VerticalTabOptionBox,   
};
