<?php
namespace Ababilithub\FlexMasterPro\Package\Plugin\Audit\V1\Concrete\Term;

use Ababilithub\{
    FlexMasterPro\Package\Plugin\Audit\V1\Base\Audit as BaseAudit
};
...
class Audit extends BaseAudit
{
    ...
    public function view_details(): void 
    {
        ...
        ?>
        <h3><?php printf(esc_html__('Term details of #%d', 'flex-master-pro'), 
                $term->term_id); ?>
        </h3>
        <?php
        ...
        ?>
        <h3><?php printf(esc_html__('Term Metas of "%s"', 'flex-master-pro'), 
                esc_html($term->name)); ?>
        </h3>
        <?php
    ...
    protected function render_header(\WP_Term $term): void
    {
        ...
        ?>
        <div class="wrap">
            <h1><?php printf(esc_html__('Term Data for #%d: %s', 'flex-master-pro'), 
                $term->term_id, 
                esc_html($term->name)); ?>
            </h1>
            <?php if ($edit_link): ?>
                <p>
                    <a href="<?php echo esc_url($edit_link); ?>" class="button">
                        &larr; <?php esc_html_e('Back to term editor', 'flex-master-pro'); ?>
                    </a>
                </p>
            <?php endif; ?>
        <?php
    ...
    protected function render_term_details(\WP_Term $term): void
    {
        ...
        <table class="widefat fixed striped">
            <tbody>
                <tr>
                    <th width="25%"><?php esc_html_e('Term ID', 'flex-master-pro'); ?></th>
                    <td><?php echo esc_html($term->term_id); ?></td>
                </tr>
                <tr>
                    <th><?php esc_html_e('Name', 'flex-master-pro'); ?></th>
                    <td><?php echo esc_html($term->name); ?></td>
                </tr>
                <tr>
                    <th><?php esc_html_e('Slug', 'flex-master-pro'); ?></th>
                    <td><?php echo esc_html($term->slug); ?></td>
                </tr>
                <tr>
                    <th><?php esc_html_e('Taxonomy', 'flex-master-pro'); ?></th>
                    <td><?php echo esc_html($term->taxonomy); ?></td>
                </tr>
                <tr>
                    <th><?php esc_html_e('Description', 'flex-master-pro'); ?></th>
                    <td><?php echo esc_html($term->description); ?></td>
                </tr>
                <tr>
                    <th><?php esc_html_e('Count', 'flex-master-pro'); ?></th>
    ...
    protected function render_meta_table(array $all_meta): void
    {
        ...
        <table class="widefat fixed striped">
            <thead>
                <tr>
                    <th width="25%"><?php esc_html_e('Meta Key', 'flex-master-pro'); ?></th>
                    <th width="75%"><?php esc_html_e('Meta Value', 'flex-master-pro'); ?></th>
                </tr>
            </thead>
            <tbody>
